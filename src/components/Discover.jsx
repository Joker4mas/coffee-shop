...
export default function Discover() {
  return (
    <div className="mt-40">
    <div className='flex gap-24 items-center text-black bg-amber-100 p-16'>
      <div className="mt-8"> 
      ...
      <h2 className="font-bold text-4xl">Discover Coffee Borcelle</h2>
        ...
        <p className="text-wrap text-xl  my-4 w-3/5">
        ...
        <div className="flex  mt-4">
          <button className="bg-amber-950 hover:bg-amber-400 text-white font-bold py-2 px-4 rounded">
